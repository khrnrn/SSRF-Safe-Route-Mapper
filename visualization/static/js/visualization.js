document.addEventListener("DOMContentLoaded", function() {
    ...
    function scanAndVisualize(targetURL) {
        ...
        .then(data => {
            ...
            // Extract scan details directly from the `data` object
            // let scanDetails = data.scan_summary || {};

            // if (data.scan_summary) {
            //     scanDetails[targetURL] = {
            //         target: data.scan_summary.target,
            //         domain: data.scan_summary.domain,
            //         totalUrls: data.scan_summary.totalUrls
            //     };
            // }
