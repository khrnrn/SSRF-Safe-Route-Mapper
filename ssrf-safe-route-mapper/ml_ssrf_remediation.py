...
# Define the folder where ML remediation results will be stored
ML_RESULTS_FOLDER = os.path.join(os.getcwd(), "scan_results", "ml_remediation")

# Ensure the folder exists
if not os.path.exists(ML_RESULTS_FOLDER):
    os.makedirs(ML_RESULTS_FOLDER)
...
cve_csv_path = os.path.join(ML_RESULTS_FOLDER, "ssrf_cve_dataset.csv")
df.to_csv(cve_csv_path, index=False)
...
df = pd.read_csv('scan_results/ml_remediation/ssrf_cve_dataset.csv')
...
preprocessed_csv_path = os.path.join(ML_RESULTS_FOLDER, "preprocessed_ssrf_dataset.csv")
